const CACHE_VERSION = 'crown-lizard-shell-115-lean-pixels';
const APP_SHELL = [
  '/',
  '/index.html',
  '/manifest.webmanifest',
  '/release.json',
  '/styles.css?v=20260909-115-lean-pixels',
  ...
  '/robots.txt',
  '/sitemap.xml',
  '/src/bootstrap.js?v=20260909-115-lean-pixels',
  '/src/main.js?v=20260909-115-lean-pixels',
  ...
  '/src/config.js?v=20260909-115-lean-pixels',
  ...
  '/src/audio.js?v=20260909-115-lean-pixels',
  '/src/game.js?v=20260909-115-lean-pixels',
  ...
  '/src/leaderboard.js?v=20260909-115-lean-pixels',

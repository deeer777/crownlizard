const CACHE_VERSION = 'crown-lizard-shell-v86-shards-stack';
const APP_SHELL = [
  '/',
  '/index.html',
  '/manifest.webmanifest',
  '/release.json',
  '/styles.css?v=20260828-86-shards-stack',
  '/src/main.js?v=20260828-86-shards-stack',
  '/src/config.js?v=20260828-86-shards-stack',
  '/src/engine.js?v=20260820-18',
  '/src/input.js?v=20260827-82-input-release',
  '/src/audio.js?v=20260828-86-shards-stack',
  '/src/game.js?v=20260828-86-shards-stack',
  '/src/boss-assault.js?v=20260828-86-shards-stack',
  '/src/boss-network.js?v=20260828-86-shards-stack',
  ...
  '/src/player-account.js?v=20260828-86-shards-stack',
  '/src/armory.js?v=20260828-86-shards-stack',

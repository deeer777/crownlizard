const CACHE_VERSION = 'crown-lizard-shell-v95-score-fix';
const APP_SHELL = [
  '/',
  '/index.html',
  '/manifest.webmanifest',
  '/release.json',
  '/styles.css?v=20260830-95-score-fix',
  ...
  '/robots.txt',
  '/sitemap.xml',
  '/src/main.js?v=20260830-95-score-fix',
  '/src/config.js?v=20260830-95-score-fix',

...
assert.match(index, /main\.js\?v=20260829-94-market-filters/, 'the current frontend ships behind a fresh browser cache key');
assert.match(main, /player-account\.js\?v=20260829-94-market-mvp/, 'the account client cannot be served from an older browser cache');

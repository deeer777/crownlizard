...
assert.match(index, /main\.js\?v=20260827-79-crown-store-final7/, 'the current frontend ships behind a fresh browser cache key');
assert.match(main, /player-account\.js\?v=20260827-79-crown-store-final4/, 'the account client cannot be served from an older browser cache');

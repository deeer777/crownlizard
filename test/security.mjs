...
assert.match(index, /main\.js\?v=20260830-96-warden-schedule-final/, 'the current frontend ships behind a fresh browser cache key');
assert.match(main, /player-account\.js\?v=20260830-95-score-fix/, 'the account client cannot be served from an older browser cache');

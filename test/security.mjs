...
assert.match(index, /main\.js\?v=20260824-61-safe-account-link/, 'the current frontend ships behind a fresh browser cache key');
assert.match(main, /player-account\.js\?v=20260824-61-safe-account-link/, 'the account client cannot be served from an older browser cache');

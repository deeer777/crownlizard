...
assert.match(index, /main\.js\?v=20260827-84-warden-rewards/, 'the current frontend ships behind a fresh browser cache key');
assert.match(main, /player-account\.js\?v=20260827-84-warden-rewards/, 'the account client cannot be served from an older browser cache');

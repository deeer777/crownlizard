...
assert.match(index, /main\.js\?v=20260826-71-callsign-ui/, 'the current frontend ships behind a fresh browser cache key');
assert.match(main, /player-account\.js\?v=20260826-71-callsign-ui/, 'the account client cannot be served from an older browser cache');
assert.match(main, /account-presentation\.js\?v=20260826-71-callsign-ui/, 'the single account presentation model ships behind the same cache boundary');

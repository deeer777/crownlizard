...
assert.match(index, /main\.js\?v=20260827-83-global-event/, 'the current frontend ships behind a fresh browser cache key');
assert.match(main, /player-account\.js\?v=20260827-83-global-event/, 'the account client cannot be served from an older browser cache');

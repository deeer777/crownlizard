...
assert.match(index, /main\.js\?v=20260828-85-mobile-type/, 'the current frontend ships behind a fresh browser cache key');
assert.match(main, /player-account\.js\?v=20260828-85-mobile-type/, 'the account client cannot be served from an older browser cache');

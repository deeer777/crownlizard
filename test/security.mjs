...
assert.match(index, /main\.js\?v=20260828-91-weapon-skins4/, 'the current frontend ships behind a fresh browser cache key');
assert.match(main, /player-account\.js\?v=20260828-91-weapon-skins4/, 'the account client cannot be served from an older browser cache');

...
assert.match(index, /main\.js\?v=20260831-99-security/, 'the current frontend ships behind a fresh browser cache key');
assert.match(main, /player-account\.js\?v=20260831-99-security/, 'the account client cannot be served from an older browser cache');

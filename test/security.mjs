...
assert.match(index, /main\.js\?v=20260824-48-session-recovery/, 'the stale mobile session recovery ships behind a fresh browser cache key');
assert.match(main, /player-account\.js\?v=20260824-48-session-recovery/, 'the repaired account client cannot be served from an older browser cache');

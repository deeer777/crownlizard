...
assert.match(html, /id="gameVersion"[^>]*>VER 0\.46\.0 · BUILD 114<\/span>/);
assert.match(main, /config\.js\?v=20260909-114-pilot-ranking/);
assert.match(serviceWorker, /crown-lizard-shell-114-pilot-ranking/);

...
assert.match(html, /id="gameVersion"[^>]*>VER 0\.48\.0 · BUILD 117<\/span>/);
assert.match(main, /config\.js\?v=20260910-117-crown-cadence/);
assert.match(serviceWorker, /crown-lizard-shell-117-crown-cadence/);

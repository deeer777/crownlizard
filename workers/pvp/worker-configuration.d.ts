/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/pvp/wrangler.jsonc workers/pvp/worker-configuration.d.ts` (hash: 565be068c8312069e937a908bb8d0f28)
// Runtime types generated with workerd@1.20260828.1 2026-08-31 nodejs_compat
interface __BaseEnv_Env {
	DUEL_ROOMS: DurableObjectNamespace<import("./src/index").DuelRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DuelRoom";
	}
